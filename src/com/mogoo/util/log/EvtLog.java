...
public class EvtLog {
	 ...
	 * 
	 */
	public static void d(Class<?> clsss, String tag, String msg) {
		if (IS_DEBUG_LOGGABLE) {
			if(clsss != null) {
				String[] classInfo = getInvokeClassInfo(clsss.getName());
	 ...
	 * 
	 */
	public static void i(Class<?> clsss, String tag, String msg) {
		if (IS_DEBUG_LOGGABLE) {
			if(clsss != null) {
				String[] classInfo = getInvokeClassInfo(clsss.getName());
	 ...
	 * 
	 */
	public static void w(Class<?> clsss, String tag, String msg) {
		if (IS_DEBUG_LOGGABLE) {
			if(clsss != null) {
				String[] classInfo = getInvokeClassInfo(clsss.getName());
	 ...
	 * 
	 */
	public static void e(Class<?> clsss, String tag, String msg) {
		if (IS_DEBUG_LOGGABLE) {
			if(clsss != null) {
				String[] classInfo = getInvokeClassInfo(clsss.getName());
	 ...
	 * 
	 */
	public static void e(Throwable exception, String tag, String msg) {
		if (IS_DEBUG_LOGGABLE) {
			if(exception != null) {
				String[] classInfo = getInvokeClassInfo(exception);
				Log.e(tag, formatLogToString(classInfo, tag, msg));
	...
	static String formatLogToString(String[] classInfo, String tag, String msg) {
		...
		if (classInfo != null) {
			...
			sb.append("[" + classInfo[INDEX_LINE] + "]");
		}
		sb.append("[" + msg + "]");
		return sb.toString();
	}
