...
public class PullToRefreshListView extends ListView implements OnScrollListener {  
    ...
    private String lastUpdatedTextPrefix = "";
    
    public OnRefreshListener refreshListener;  
    
    private PullToRefreshListViewStateListener mStateListener;
    
	public static interface PullToRefreshListViewStateListener {
    ...
    public void onLoading() {
		if (mStateListener != null) {
			mStateListener.onStateChanged(PullToRefreshListViewStateListener.STATE_LOADING);
		}
	}
    
    public void onPull() {
		if (mStateListener != null)
			mStateListener.onStateChanged(PullToRefreshListViewStateListener.STATE_PULL);
	}

    public void onRecover() {
		if (mStateListener != null)
			mStateListener.onStateChanged(PullToRefreshListViewStateListener.STATE_RECOVER);
	}
    ...
    public void setStateListener(PullToRefreshListViewStateListener stateListener) {
    ...
    private void init(Context context) {   
        ...
        lastUpdatedTextPrefix = context.getString(R.string.overefresh_update);
    ...
    */
	...
	public void setRefreshTime() {
		String s = (new SimpleDateFormat("MM-dd HH:mm")).format(new Date());
		lastUpdatedTextView.setText(lastUpdatedTextPrefix + s);
	}
    ...
    protected void setListViewOverScrollModeNever() {
		if(android.os.Build.VERSION.SDK_INT >= 9) {
			try {
				...
				Method localMethod = localClass.getMethod("setOverScrollMode", arrayOfClass);
				Object[] arrayOfObject = new Object[1];
				arrayOfObject[0] = Integer.valueOf(View.OVER_SCROLL_NEVER);
