                    ...
                    if (loadSize <= 0) {
                        if (isContentTypeSatisfy(contentType)) {
                            ...
                            if (length > 0) {
                                if (loadSize == 0) {
                                    totalSize = length;
                                    path = new StringBuilder(ResourceUtility.getPath(this, urlStr))
                                            .append(ResourceUtility.tmp).toString();
                                ...
                                if (totalSize == loadSize + length) {
                                    ...
                                    if (downloadFlag) {
                                        int k;
                                        if ((k = inputstream.read(buffer, 0, 4096)) <= 0) /*
                                                                                           * goto
                                                                                           * _L15
                                                                                           * ;
                                                                                           * else
                                    ...
                                    Log.e(tag, (new StringBuilder(
                                            ...
                                            append(totalSize).append(",loadSize:").append(loadSize)
                                            .append(",fileSize:").append(length).toString());
                                }
                            } else {
                                return false;
                            }
