...
import com.mogoo.MogooApplicationBase;
...
public class PackageUtil {
	...
	public static int getVersionCode() throws NameNotFoundException {
		int verCode = MogooApplicationBase.CONTEXT.getPackageManager().getPackageInfo(
				MogooApplicationBase.CONTEXT.getPackageName(), 0).versionCode;
	...
	public static String getVersionName() throws NameNotFoundException {
		String versionName = MogooApplicationBase.CONTEXT.getPackageManager().getPackageInfo(
				MogooApplicationBase.CONTEXT.getPackageName(), 0).versionName;
	...
	public static String getLocalMacAddress() {
		WifiManager wifi = (WifiManager) MogooApplicationBase.CONTEXT.getSystemService(Context.WIFI_SERVICE);
	...
	public static String getString(int resourceId) {
		Resources res = MogooApplicationBase.CONTEXT.getResources();
	...
	public static String getTerminalSign() {
		...
		TelephonyManager tm = (TelephonyManager) MogooApplicationBase.CONTEXT.getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static String getConfigString(String key) {
		String val = "";
		try {
			ApplicationInfo appInfo = MogooApplicationBase.CONTEXT.getPackageManager().getApplicationInfo(
					MogooApplicationBase.CONTEXT.getPackageName(), PackageManager.GET_META_DATA);
