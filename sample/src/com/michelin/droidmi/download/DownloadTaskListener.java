...
public abstract class DownloadTaskListener extends Handler {
	static final String tag = "DownloadTaskListener";
	...
	public void handleMessage(Message paramMessage) {
		if (this.task != null)
			...
			case 1:
				...
				// LogUtil.d(tag, "handleMessage:" + this.task.name +
				// ",percent:" + this.task.percent);
				break;
			case 2:
				// LogUtil.d(tag, "handleMessage:" + this.task.name + ",state:"
				// + DownloadUtility.getStateInfo(this.task.getState()));
