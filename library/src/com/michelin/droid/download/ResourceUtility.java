...
public class ResourceUtility {
	...
	public static final int RESOURCE_TYPE_SOFT = 1;
	public static final int RESOURCE_TYPE_THEME = 2;
	public static final int RESOURCE_TYPE_RING = 3;
	public static final int RESOURCE_TYPE_PICTURE = 4;
	 ...
	 * @date 2012-12-24
	 * @param type
	 *            下载的文件类型1为app,2为theme,3为rings,4为pic
	 * @param subPath
	 *            下载路径的子路径
	 * @return
	 */
	...
	public static File searchApk(String resName, String verName,
			String resId) {
		String parentPath = SystemConst.BASE_DIR + "/" + "apps/";
		String fileName = getFileName(resName, verName, resId);
		String fullPath = parentPath + fileName + ".apk";
