...
/**
 * Title: EvtLog</p>
 * Description: 日志打印工具类</p>
 * @author lin.xr
 * @date 2014-6-27 下午11:35:33
 */
public class EvtLog {

	static final String TAG = "EvtLog";
	...
	/**
	 * 是否属于sdk文档列出的java.net包中抛出的网络异常
	 * 
	 * @param exception
	 *            异常
	 * @return boolean 是否属于网络异常
	 */
	...
	static String[] getInvokeClassInfo(String className) {
		...
		if (stack != null) {
			...
			if (index > -1) {
				...
				// 行号
				result[INDEX_LINE] = String.valueOf(stack[index]
						.getLineNumber());
			}
		}
		return result;
	 ...
	 * @param msg
	 *            信息
	 * @return String 格式化后带标签、信息的日志字符串
	 */
	 ...
	 * @param msg
	 *            信息
	 * @return String 格式化后带标签、类名、方法、行号、信息的日志字符串
	 */
